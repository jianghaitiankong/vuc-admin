		...
		<div class="container">
			<div class="form-box" style="position: relative;">
				<el-form ref="form" :model="form" label-width="80px" :rules="rules">
					...
					<el-form-item prop="addName" label="基地总部">
						<el-input v-model="form.addName" name="names" style="width:360px;"></el-input>
					</el-form-item>
					<el-form-item prop="addNddress" label="基地地址">
						<el-input v-model="form.addNddress"></el-input>
					</el-form-item>
					<el-form-item prop="addContacts" label="联系人" >
						<el-input v-model="form.addContacts"></el-input>
					</el-form-item>
					<el-form-item prop="addTel" label="手机" >
						<el-input v-model="form.addTel" maxlength="11"></el-input>
					</el-form-item>
					<el-form-item>
          ...
          that.$request.imgPost("file/upload", this.param , that.token).then(function(result) {
              if (result.data.success === "文件上传成功") {
                var data = {
                  ...
                  contactHQ: that.form.addName, //基地总部
                  contactAddress: that.form.addNddress, //基地位置
                  contactUser: that.form.addContacts, //联系人
                  contactPhone: that.form.addTel //联系电话
                };
                that.$request.post("contact/insertAllContact", data, that.token).then(res => {
